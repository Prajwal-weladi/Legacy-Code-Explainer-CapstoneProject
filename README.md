...
2. **New API Endpoint**
   ...
   - Define schema in `models/schemas.py`
   - Add tests in `tests/test_routes.py`

3. **New Service**
   - Create in `services/new_service.py`
   - Add tests in `tests/test_services.py`
...
**Solutions**:
- Check file extension (must be .cbl, .cob, .jcl, or .txt)
- Check file size (max 5MB)
- Ensure file is readable

### Issue: No AI explanation generated
**Solutions**:
- Verify Ollama is running: `ollama serve`
- Check Ollama model: `ollama pull codellama`
- Check timeout setting (OLLAMA_TIMEOUT)
- Review server logs
...
### Benchmarks
- **File Upload**: < 100ms
- **COBOL Parsing**: 50-500ms (depends on file size)
- **JCL Parsing**: 20-200ms
- **AI Explanation**: 2-5 seconds (depends on Ollama)
- **Total Analysis**: 2-6 seconds

### Optimization Tips
1. Use faster SSD for uploads
2. Increase OLLAMA_TIMEOUT for large explanations
...
5. Monitor upload directory for malicious files

---

## 📝 License

This project is part of the GlideCloud Internship Program.
...
- [ ] Configure OLLAMA_HOST to production Ollama server
- [ ] Enable HTTPS/SSL
...
**January 16, 2026**
- ✅ Created comprehensive test suite (94 tests, 97% coverage)
- ✅ Added detailed documentation
- ✅ Implemented COBOL and JCL parsers
- ✅ Integrated Ollama for AI explanations
...
- **COBOL Parsing**: See `backend/parsers/cobol_parser.py`
- **JCL Parsing**: See `backend/parsers/jcl_parser.py`
